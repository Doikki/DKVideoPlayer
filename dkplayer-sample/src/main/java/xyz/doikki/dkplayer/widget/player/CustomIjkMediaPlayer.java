...
import xyz.doikki.videoplayer.ijk.IjkMPlayer;

public class CustomIjkMediaPlayer extends IjkMPlayer {
    ...
    public void setPlayerOption(String name, String value) {
        mMediaPlayer.setOption(tv.danmaku.ijk.media.player.IjkMediaPlayer.OPT_CATEGORY_PLAYER, name, value);
    }
    ...
    public void setFormatOption(String name, String value) {
        mMediaPlayer.setOption(tv.danmaku.ijk.media.player.IjkMediaPlayer.OPT_CATEGORY_FORMAT, name, value);
    }
    ...
    public void setCodecOption(String name, String value) {
        mMediaPlayer.setOption(tv.danmaku.ijk.media.player.IjkMediaPlayer.OPT_CATEGORY_CODEC, name, value);
    }
    ...
    public void setSwsOption(String name, String value) {
        mMediaPlayer.setOption(tv.danmaku.ijk.media.player.IjkMediaPlayer.OPT_CATEGORY_SWS, name, value);
    }
