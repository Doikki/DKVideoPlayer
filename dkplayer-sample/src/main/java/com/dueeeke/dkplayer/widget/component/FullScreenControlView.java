 ...
 * 全屏底部控制栏
 */
public class FullScreenControlView extends FrameLayout implements IControlComponent, View.OnClickListener, SeekBar.OnSeekBarChangeListener {
    ...
    public FullScreenControlView(@NonNull Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
    ...
    {
        setVisibility(GONE);
        LayoutInflater.from(getContext()).inflate(R.layout.layout_full_screen_control_view, this, true);
